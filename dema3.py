...
pdf_folder = 'C:\\Users\\TTCNTT\\Desktop\\HOP1'
#pdf_folder = '/mnt/d/04. Phường Thịnh Lang'

# Lấy tên thư mục cha và thêm ".xlsx" vào tên
excel_file_name = os.path.basename(os.path.normpath(pdf_folder)) + '.xls'
...
worksheet.cell(row=1, column=2, value='Đường dẫn tuyệt đối')
