...
# Sử dụng hàm glob để tìm kiếm tất cả các file pdf trong thư mục
#pdf_files = glob.glob(os.directory.join(directory, "*.pdf"))


# Đường dẫn đến thư mục chứa các file pdf
#path = "/mnt/c/Users/admin/Desktop/pdf_folder"

# Sử dụng hàm glob để tìm kiếm tất cả các file pdf trong thư mục
#pdf_files = glob.glob(os.path.join(path, "*.pdf"))

# Sử dụng hàm len() để đếm số lượng file pdf được tìm thấy
#num_pdf_files = len(pdf_files)

#print(f"Số lượng file pdf trong thư mục {path} là: {num_pdf_files}")

# Define the directory containing the PDF files
directory = "/mnt/d/HoaBinh/11. YenMong/timmucluc"
...
with pd.ExcelWriter('YM.CGCN-mucluc.xlsx') as writer:
